...
void imguiManager::WaitForLastSubmittedFrame()
{
...
FrameContext* imguiManager::WaitForNextFrameResources()
{
...
void imguiManager::ResizeSwapChain(HWND hWnd, int width, int height)
{
    DXGI_SWAP_CHAIN_DESC1 sd;
